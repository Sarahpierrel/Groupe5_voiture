    ...
    def steer(self, frame, lane_lines):
        ...
        if self.car is not None:
            ...
            if self.curr_steering_angle < 80: # threshold set based on several tests
                ...
                #ser.write([2, self.speedTurning],2)
                ser.write('L'.encode())
                ...
                #data = ser.write([1, self.speed], 2)
                #er.write([1, self.speed],2)
                ser.write('F'.encode())
                line = ser.readline().decode('utf-8').rstrip()
                print(line)
            else :
                #ser.write(struct.pack('>B', 3))
                #data = ser.write([4, self.speedTurning], 2)
                ser.write('R'.encode())
                #ser.write([3, self.speedTurning],2)
                line = ser.readline().decode('utf-8').rstrip()
                print(line)
